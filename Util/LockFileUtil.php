...
final class LockFileUtil
{
    ...
    {
        return $this->errorMsg.' It is not safe to overwrite it. '. PHP_EOL .
            'For more details please refer to https://github.com/interpunkt/meat-up/blob/master/Resources/doc/lock_file.md';
    }
